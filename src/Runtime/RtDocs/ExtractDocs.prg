...
//
// Example:
//   ExtractDocs ..\Runtime\XSharp.Core XSharp.CoreDocs.xml ..\..\..\Docs\XSharp.CoreDocs.xml
...
STATIC CLASS XSharpKeywords
    ...
    STATIC CONSTRUCTOR
        ...
        FOREACH VAR kw IN <STRING>{"function","procedure"}
...
FUNCTION Start() AS VOID STRICT
    ...
    IF args:Length < 4
        cFolder  := @"..\..\Runtime\XSharp.Core"
        cXmlFile := "XSharp.CoreDocs.xml"
        cXmlPath := @"..\..\..\Docs\XSharp.CoreDocs.xml"
    ELSE
        cFolder  := args[1]
        cXmlFile := args[2]
        cXmlPath := args[3]
