...
/// <include file="XSharp.CoreDocs.xml" path="doc/ConTime/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/ConDateTime/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/CToDt/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/CToDtAnsi/*" />
FUNCTION CToDtAnsi(cDate AS STRING) AS DateTime
	RETURN CToDt(cDate, "YYYY.MM.DD")


/// <include file="XSharp.CoreDocs.xml" path="doc/DtToC/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/DtToS/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/SToDt/*" />
