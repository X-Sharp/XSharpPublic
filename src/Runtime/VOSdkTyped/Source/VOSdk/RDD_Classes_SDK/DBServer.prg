...
method __SetupLocks( )  as void strict
    ...
    otherwise
        oErrorInfo := DbError{ self, __FUNCTION__, EG_ARG,  ;
...
constructor( cFile as usual, lShareMode := null as object, lReadOnlyMode := null as object, xDriver:= "" as string, aRDD := null_array as array)
    ...
    elseif cFile is string var strFile
        ...
        break DbError{ self, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_BADFILENAME ),  cFile, "cFile" }
    endif
...
constructor( oFS := null as FileSpec, lShareMode := null as object, lReadOnlyMode := null as object, xDriver:= "" as string, aRDD := null_array as array)
    ...
    begin sequence
        ...
        if oFS == null
            break DbError{ self, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_NOFILENAME ),  ;
                nil, "oFs" }
        endif
        ...
        elseif lShareMode is logic var lSh
            ...
            break DbError{ self, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_BADSHAREMODE ),  lShareMode, "lShareMode" }
        endif
        ...
        elseif lReadOnlyMode is logic
            ...
            break DbError{ self, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_BADREADONLYMODE ),  ;
