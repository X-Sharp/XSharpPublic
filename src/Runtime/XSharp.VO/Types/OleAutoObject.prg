...
CLASS XSharp.OleAutoObject IMPLEMENTS IDynamicProperties, ILateBound
    ...
    static method OleGetObject(cProgId as string) as object
        ...
        try
            #ifdef NET5_0_OR_GREATER
                oComObject := OleWin32.GetActiveObject(cProgId)
            #else
...
#ifdef NET5_0_OR_GREATER
internal Static Class OleWin32
    const OLE32 := "ole32.dll" as string
    const OLEAUT32 := "oleaut32.dll" as string

    [DllImport(OLE32, PreserveSig := false)];
    [ResourceExposure(ResourceScope.None)] ;
    [SuppressUnmanagedCodeSecurity] ;
    [System.Security.SecurityCritical ];  // auto-generated
    internal static extern method CLSIDFromProgIDEx([MarshalAs(UnmanagedType.LPWStr)] progId as String , clsid out Guid) as void

    [DllImport(OLE32, PreserveSig := false)];
    [ResourceExposure(ResourceScope.None)] ;
    [SuppressUnmanagedCodeSecurity] ;
    [System.Security.SecurityCritical ];  // auto-generated
    internal static extern method CLSIDFromProgID([MarshalAs(UnmanagedType.LPWStr)] progId as String , clsid out Guid) as void

    [DllImport(OLEAUT32, PreserveSig := false)];
    [ResourceExposure(ResourceScope.None)];
    [SuppressUnmanagedCodeSecurity];
    [System.Security.SecurityCritical] ; // auto-generated
    internal static extern method GetActiveObject(rclsid ref Guid , reserved as IntPtr , [MarshalAs(UnmanagedType.Interface)] punk out Object) as void


    internal static method GetActiveObject(progId as String) as Object
        local clsid as Guid
        try
            OleWin32.CLSIDFromProgIDEx(progId, OUT clsid)
        catch
            OleWin32.CLSIDFromProgID(progId, OUT clsid)
        end try
        if clsid == Guid.Empty
            return null
        endif
        OleWin32.GetActiveObject(REF clsid, IntPtr.Zero, OUT VAR obj)
        return obj
    end method
