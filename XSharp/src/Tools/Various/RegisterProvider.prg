DEFINE PROVIDERVERSION := "XSharp.CodeDom.XSharpCodeDomProvider,XSharpCodeDomProvider, Version=1.0.0.0, Culture=neutral, PublicKeyToken=31c59c566fa38f21, ProcessorArchitecture=MSIL" AS STRING
