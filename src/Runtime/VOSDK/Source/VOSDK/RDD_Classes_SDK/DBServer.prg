    ...
    BEGIN SEQUENCE
        ...
        ELSEIF IsNil( oFile )
            BREAK DbError{ SELF, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_NOFILENAME ),  ;
                NIL, "oFile" }
        ELSE
            BREAK DbError{ SELF, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_BADFILENAME ),  ;
                oFile, "oFile" }
        ENDIF
        ...
        ELSEIF IsSymbol( lShareMode )
            ...
            ELSEIF lShareMode = #Exclusive
                SELF:lShared := FALSE
            ELSE
                BREAK DbError{ SELF, __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_BADSHAREMODE ),  ;
