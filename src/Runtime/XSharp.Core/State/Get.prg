...
FUNCTION GetAnsi() AS LOGIC
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/GetChunkBase64/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/GetMimType/*" />
...
FUNCTION GetTimeSep() AS DWORD
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/GetTimeZoneDiff/*" />
