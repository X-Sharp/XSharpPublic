...
END NAMESPACE
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/XSharp.StateChanged/*" />
DELEGATE XSharp.StateChanged (e AS StateChangedEventArgs) AS VOID
    /// <include file="XSharp.CoreDocs.xml" path="doc/XSharp.DialectChanged/*" />
DELEGATE XSharp.DialectChanged(oldDialect as XSharpDialect, newDialect as XSharpDialect) AS VOID

/// <include file="XSharp.CoreDocs.xml" path="doc/StateChangedEventArgs/*" />
CLASS XSharp.StateChangedEventArgs
    /// <include file="XSharp.CoreDocs.xml" path="doc/StateChangedEventArgs.Setting/*" />
    PROPERTY Setting  AS XSharp.Set AUTO GET INIT
    /// <include file="XSharp.CoreDocs.xml" path="doc/StateChangedEventArgs.OldValue/*" />
    PROPERTY OldValue AS OBJECT AUTO GET INIT
    /// <include file="XSharp.CoreDocs.xml" path="doc/StateChangedEventArgs.NewValue/*" />
    PROPERTY NewValue AS OBJECT AUTO GET INIT
    INTERNAL CONSTRUCTOR()
        RETURN
END CLASS
/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState/*" />
CLASS XSharp.RuntimeState
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.GetInstance/*" />
	PUBLIC STATIC METHOD GetInstance() AS RuntimeState
		RETURN currentState:Value
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.StateChanged/*" />
    PUBLIC STATIC EVENT StateChanged AS StateChanged
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.DialectChanged/*" />
    PUBLIC STATIC EVENT DialectChanged as DialectChanged
    [DebuggerBrowsable(DebuggerBrowsableState.Never)];
	PRIVATE oSettings AS Dictionary<XSharp.Set, OBJECT>
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Settings/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Name/*" />
    ...
    END GET
    END PROPERTY
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.BreakLevel/*" />
	PUBLIC PROPERTY BreakLevel AS INT AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.ToString/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionFox2/*" />
	STATIC PROPERTY CompilerOptionFox2 AS LOGIC AUTO

	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionAllowOldStyleAssignments/*" />
	STATIC PROPERTY CompilerOptionAllowOldStyleAssignments AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionAZ/*" />
	STATIC PROPERTY CompilerOptionAZ AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO4/*" />
	STATIC PROPERTY CompilerOptionVO4 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO6/*" />
	STATIC PROPERTY CompilerOptionVO6 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO7/*" />
	STATIC PROPERTY CompilerOptionVO7 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO10/*" />
	STATIC PROPERTY CompilerOptionVO10 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO11/*" />
	STATIC PROPERTY CompilerOptionVO11 AS LOGIC AUTO

	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO12/*" />
	STATIC PROPERTY CompilerOptionVO12 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO13/*" />
	STATIC PROPERTY CompilerOptionVO13 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionVO14/*" />
	STATIC PROPERTY CompilerOptionVO14 AS LOGIC AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CurrentWorkarea/*" />
    STATIC PROPERTY CurrentWorkarea AS DWORD ;
        GET Workareas:CurrentWorkareaNO ;
        SET Workareas:CurrentWorkareaNO  := value

    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CompilerOptionOVF/*" />
   ...
   static property CollationMode as CollationMode
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.DateCountry/*" />
   STATIC PROPERTY DateCountry AS DWORD ;
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Eof/*" />
    STATIC PROPERTY Eof AS LOGIC ;
        GET GetValue<LOGIC>(Set.Eof);
        SET SetValue<LOGIC>(Set.Eof, value)


	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Eol/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.FloatDelta/*" />
   STATIC PROPERTY FloatDelta AS REAL8 ;
        GET GetValue<REAL8>(Set.Floatdelta);
        SET SetValue<REAL8>(Set.Floatdelta, value)

	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.International/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.LastRddError/*" />
    STATIC PROPERTY LastRddError AS Exception AUTO

	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.LastScriptError/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.LockTries/*" />
   ...
   STATIC PROPERTY Refresh AS REAL8 ;
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Unique/*" />
    STATIC PROPERTY Unique AS LOGIC ;
        GET GetValue<LOGIC>(Set.Unique);
        SET SetValue<LOGIC>(Set.Unique, value)

	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.WinCodePage/*" />
	...
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.Workareas/*" />
    PUBLIC STATIC PROPERTY Workareas AS DataSession GET DataSession
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.DataSession/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.SetDataSession/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.AutoLockMethod/*" />
    delegate AutoLockMethod() as void

    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.CollationTable/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.ScriptCompiler/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.MacroCompiler/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.MacroCompilerIncludeAssemblyInCache/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.MacroResolver/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.MacroCompilerErrorHandler/*" />
    PUBLIC STATIC PROPERTY MacroCompilerErrorHandler as MacroCompilerErrorHandler AUTO
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.OnCodePageChanged/*" />
	PUBLIC STATIC EVENT OnCodePageChanged AS EventHandler
	/// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.OnCollationChanged/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.StringCompare/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.StringCompareCollation/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RuntimeState.StringCompare_2/*" />
