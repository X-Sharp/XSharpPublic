...
#ENDIF
    ...
    ELSE
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__CON_ALLOC ), __FUNCTION__ )
    ENDIF
...
#ENDIF
    ...
    IF hEnv = SQL_NULL_HENV
        ...
        ENDIF
    ELSE
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__ENV_ALLOC ), __FUNCTION__ )
    ENDIF
...
#ENDIF
    ...
    IF hDbc = SQL_NULL_HDBC
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__CON_FREE ), __FUNCTION__ )
    ELSE
        ...
        IF nRetCode = SQL_SUCCESS
            ...
            lRet := TRUE
        ELSE
            oErrInfo := SQLErrorInfo{ SELF, __FUNCTION__, hEnv,      ;
...
#ENDIF
    ...
    IF hEnv = SQL_NULL_HENV
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__ENV_FREE ), __FUNCTION__ )
    ELSE
        IF  __DropMyEnv( hEnv )
...
#ENDIF
    ...
    IF !SELF:lConnFlag
        ...
        ENDIF
    ELSE
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__CONNECTED ), __FUNCTION__ )
    ENDIF
    RETURN lRet
...
#ENDIF
        ...
        IF nRetCode = SQL_NO_DATA_FOUND
            SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__CANCELLED ), __FUNCTION__ )
...
#ENDIF
    ...
    IF hDbc = SQL_NULL_HDBC
        SELF:__GenerateSqlError( __CavoStr( __CAVOSTR_SQLCLASS__NOT_CONN ), __FUNCTION__ )
    ELSE
