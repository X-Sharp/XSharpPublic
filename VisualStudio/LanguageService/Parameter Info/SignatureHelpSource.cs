    ...
    internal class XSharpSignatureHelpSource : ISignatureHelpSource
    {
        ...
        public void AugmentSignatureHelpSession(ISignatureHelpSession session, IList<ISignature> signatures)
        {
            try
            {
                ...
                XSharpLanguageService.DisplayOutPutMessage("XSharpSignatureHelpSource.AugmentSignatureHelpSession()");
                ...
                else if (elt is System.Reflection.MemberInfo)
                {
                    ...
                    MemberAnalysis analysis = new MemberAnalysis(element);
            ...
            {
                XSharpLanguageService.DisplayOutPutMessage("XSharpSignatureHelpSource.AugmentSignatureHelpSession Exception failed " );
        ...
        {
            XSharpLanguageService.DisplayOutPutMessage("XSharpSignatureHelpSource.SystemNameSake()");
            MemberInfo[] members;
        ...
        private XSharpSignature CreateSignature(ITextBuffer textBuffer, MemberInfo member, string methodSig, string methodDoc, ITrackingSpan span, bool comma, bool isCtor, XFile file )
        {
            ...
            XSharpLanguageService.DisplayOutPutMessage("XSharpSignatureHelpSource.CreateSignature()");
