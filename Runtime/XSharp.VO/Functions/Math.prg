...
FUNCTION ACot(n AS USUAL) AS FLOAT
    RETURN 2 * Math.ATan(1) + Math.ATan( (REAL8) n)
...
FUNCTION POW(x AS USUAL,y AS USUAL) AS FLOAT
    RETURN Math.Pow((REAL8)x, (REAL8)y)
