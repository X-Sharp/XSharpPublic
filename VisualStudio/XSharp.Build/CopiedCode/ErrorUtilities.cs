...
namespace Microsoft.Build.Shared
{
    ...
    internal static class ErrorUtilities
    {
        ...
        internal static void VerifyThrowArgumentNull(object parameter, string parameterName, string resourceName)
        {
            ...
            {
                throw new ArgumentNullException(Microsoft.Build.Shared.ResourceUtilities.FormatResourceString(resourceName, parameterName), (Exception)null);
            }
        }
...
namespace Microsoft.Build.Shared
{
    ...
    internal static class MetadataConversionUtilities
    {
        internal static bool TryConvertItemMetadataToBool(ITaskItem item, string itemMetadataName, out bool metadataFound)
        {
            ...
            try
            {
                return ConversionUtilities.ConvertStringToBool(metadata);
            }
            catch (ArgumentException innerException)
            {
                throw new ArgumentException(Microsoft.Build.Shared.ResourceUtilities.FormatResourceString("General.InvalidAttributeMetadata", item.ItemSpec, itemMetadataName, metadata, "bool"), innerException);
            }
        }
    ...
    internal static class ConversionUtilities
    {
        ...
        {
            return double.Parse(number, NumberStyles.AllowLeadingSign | NumberStyles.AllowDecimalPoint, CultureInfo.InvariantCulture.NumberFormat);
        }

        internal static double ConvertHexToDouble(string number)
        {
            return int.Parse(number.Substring(2), NumberStyles.AllowHexSpecifier, CultureInfo.InvariantCulture.NumberFormat);
        }
        ...
        private static bool ValidHexNumber(string number)
        {
            ...
            {
                int _;
                result = Int32.TryParse(number.Substring(2), NumberStyles.AllowHexSpecifier, CultureInfo.InvariantCulture.NumberFormat, out _);
            }
            return result;
        }
        ...
        {
            double result;
            return double.TryParse(number, NumberStyles.AllowLeadingSign | NumberStyles.AllowDecimalPoint, CultureInfo.InvariantCulture.NumberFormat, out result);
        }
