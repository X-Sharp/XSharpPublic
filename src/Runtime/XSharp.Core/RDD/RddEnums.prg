...
ENUM DbOrder_Info
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbOrder_Info.DBOI_STRICTREAD/*" />
...
ENUM DbFieldType AS BYTE
    ...
    /*
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.AutoIncrement/*" />
    MEMBER AutoIncrement	:= 43
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.Integer2/*" />
    MEMBER Integer2		:= 50
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.Integer4/*" />
    MEMBER Integer4		:= 52
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.Double8/*" />
    MEMBER Double8		:= 56
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.ModTime/*" />
    MEMBER ModTime		:= 61
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.TimeStamp/*" />
    MEMBER TimeStamp		:= 64
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.CurrencyDouble/*" />
    MEMBER CurrencyDouble	:= 90
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbFieldType.RowVer/*" />
    MEMBER RowVer			:= 94
    */
END	 ENUM
...
/// <include file="XSharp.CoreDocs.xml" path="doc/DbNotificationType/*" />
