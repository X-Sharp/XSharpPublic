...
msbuild Compiler.sln /fl1 /p:Configuration=%1 /p:Platform="Any CPU" /p:RoslynSemanticVersion=%Version% /t:Build /p:OfficialBuild=%OfficialBuild% /p:BuildNumber=%BuildNumber% /m /v:m /nologo
