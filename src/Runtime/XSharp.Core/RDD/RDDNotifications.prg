...
/// <include file="XSharp.CoreDocs.xml" path="doc/DbRegisterClient/*" />
FUNCTION DbRegisterClient(oClient AS IDbNotify) AS LOGIC
    CoreDb.Notify += oClient:Notify
    RETURN TRUE

/// <include file="XSharp.CoreDocs.xml" path="doc/DbUnRegisterClient/*" />
FUNCTION DbUnRegisterClient(oClient AS IDbNotify) AS LOGIC
    CoreDb.Notify -= oClient:Notify
    RETURN TRUE


/// <include file="XSharp.CoreDocs.xml" path="doc/DbNotifyEventArgs/*" />
CLASS XSharp.DbNotifyEventArgs
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbNotifyEventArgs.Type/*" />
    PUBLIC PROPERTY Type    AS DbNotificationType AUTO GET PRIVATE SET
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbNotifyEventArgs.Data/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/IDbNotify/*" />
