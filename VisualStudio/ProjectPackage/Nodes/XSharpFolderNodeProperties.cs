...
namespace XSharp.Project
{
    ...
    public class XSharpFolderNodeProperties : FolderNodeProperties
    {
        // =========================================================================================
        // Constructors
        // =========================================================================================
        ...
        public XSharpFolderNodeProperties(XFolderNode  node)
            : base(node)
        {
        }
        ...
        {
            return new XSharpDesignPropertyDescriptor(propertyDescriptor);
        }
    }
}
