...
BEGIN NAMESPACE XSharp.RDD.NTX
    ...
    INTERNAL CLASS NtxLevel INHERIT NtxPage
        ...
        INTERNAL PROPERTY BaseKeys  AS DWORD AUTO
        INTERNAL PROPERTY Keys      AS DWORD AUTO
        INTERNAL PROPERTY ExtraKeys AS DWORD AUTO
        INTERNAL PROPERTY Parents   AS DWORD AUTO
