...
BEGIN NAMESPACE XSharp.RDD
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager/*" />
    CLASS DbcManager
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.ExtendDbName/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.Open/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.ValidateStructure/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.Close/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.FindDatabase/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.FindDatabaseByName/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcManager.CreateDatabase/*" />
    ...
    CLASS DbcDatabase INHERIT DbcObject
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Active/*" />
        PROPERTY Active         AS LOGIC AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Area/*" />
        PROPERTY Area           AS DWORD AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Name/*" />
        PROPERTY Name           AS STRING AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.FileName/*" />
        PROPERTY FileName       AS STRING AUTO

        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Tables/*" />
        PROPERTY Tables         as ICollection<DbcTable> GET _tables:Values
        PRIVATE _tables         AS Dictionary<String, DbcTable>

        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Connections/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.Views/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.GetProp/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcDatabase.SetProp/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable/*" />
    CLASS DbcTable INHERIT DbcObject
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable.Fields/*" />
        PROPERTY Fields     AS List<DbcField> AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable.Indexes/*" />
        PROPERTY Indexes    AS List<DbcIndex> AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable.Relations/*" />
        PROPERTY Relations  AS List<DbcRelation> AUTO
        PRIVATE _loaded     AS LOGIC
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable.Database/*" />
        PROPERTY Database   As DbcDatabase GET (DbcDatabase) SELF:Parent
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcTable.Path/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcView/*" />
    CLASS DbcView INHERIT DbcObject
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcView.Fields/*" />
        PROPERTY Fields     AS List<DbcField> AUTO
        /// <include file="XSharp.CoreDocs.xml" path="doc/DbcView.Database/*" />
        PROPERTY Database   As DbcDatabase GET (DbcDatabase) SELF:Parent
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcField/*" />
    CLASS DbcField INHERIT DbcObject
        CONSTRUCTOR
            SUPER()
    END CLASS

    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcIndex/*" />
    CLASS DbcIndex INHERIT DbcObject
        CONSTRUCTOR
            SUPER()
    END CLASS

    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcConnection/*" />
    CLASS DbcConnection INHERIT DbcObject
        CONSTRUCTOR
            SUPER()
    END CLASS

    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcRelation/*" />
    CLASS DbcRelation INHERIT DbcObject
       /// <include file="XSharp.CoreDocs.xml" path="doc/DbcRelation.RIInfo/*" />
    ...
    END CLASS
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbcOther/*" />
...
/// <include file="XSharp.CoreDocs.xml" path="doc/Dbc/*" />
STATIC CLASS XSharp.RDD.Dbc

    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.Open/*" />
    STATIC METHOD Open(cFileName AS STRING, lShared AS LOGIC, lReadOnly as LOGIC, lValidate as LOGIC) AS LOGIC
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.FindDatabase/*" />
    STATIC METHOD FindDatabase(cFileName as STRING) AS DbcDatabase
        LOCAL oDb as DbcDatabase
    ...
    STATIC METHOD CreateView(cName as STRING, cConnection := "" as STRING, lRemote := FALSE as LOGIC, lShared := FALSE as LOGIC, sSelect := "" as STRING) AS VOID
        RETURN
    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.Create/*" />
    STATIC METHOD Create(cFileName as STRING) AS LOGIC
        cFileName := DbcManager.ExtendDbName(cFileName)
        RETURN DbcManager.CreateDatabase(cFileName)


    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.Select/*" />
...
//         ENDIF
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.Close/*" />
    STATIC METHOD Close(cName as STRING) AS LOGIC
        RETURN DbcManager.Close(cName)

    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.Dump/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Dbc.DumpProperties/*" />
