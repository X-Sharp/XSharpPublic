...
BEGIN NAMESPACE XSharp.VFP.UI
    ...
    /// <summary>
    /// VFP Grid Control - Data-bound tabular data display
    /// Maps VFP Grid properties and methods to WinForms DataGridView
    /// Supports RecordSource data binding to DbDataSource with full column management
    ///
    /// Implements: IDynamicProperties, IDynamicProperties2, IVFPOwner
    /// Includes: VFPContainer.xh, VFPProperties.xh, ControlProperties.xh
    ///
    /// Base Class: System.Windows.Forms.DataGridView
    /// </summary>
    CLASS Grid INHERIT System.Windows.Forms.DataGridView IMPLEMENTS IDynamicProperties, IDynamicProperties2, IVFPOwner
        ...
        // ============================================================================
        // DATA BINDING - RecordSource / DbDataSource
        // ============================================================================
        ...
        /// <summary>
        /// Internal CurrentCellChanged. Will route to AfterRowColChange event
        /// </summary>
        ...
        /// <summary>
        /// Internal SelectionChanged, used to get "old" Row & Col
        /// </summary>
