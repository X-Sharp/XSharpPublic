...
Components: main\gac;  Source: "{#BinDllFolder}XSharp.MacroCompiler.Fast.dll";     DestDir: "{app}\Redist"; Flags: {#StdFlags} signonce {#GACInstall};  StrongAssemblyName: "XSharp.MacroCompiler.Fast{#XSharpVersion}" 
