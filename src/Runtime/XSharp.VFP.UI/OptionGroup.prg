...
/// </summary>
	PUBLIC PARTIAL CLASS OptionGroup ;
		...
		/// <summary>
		/// Number of child controls — returns <c>Controls.Count</c>. The setter is a no-op (ControlCount is read-only in VFP); it exists to satisfy the <c>IVFPOwner</c> interface.
		/// </summary>
		...
		/// <summary>
		/// 1-based indexed property — <c>Buttons[i]</c> returns the <see cref="OptionButton"/> at position <c>i</c>. Alias for <see cref="Button"/>.
		/// </summary>
		...
		/// <summary>
		/// Returns the <see cref="OptionButton"/> at the given 1-based index. Equivalent to <c>Buttons[i]</c>.
		/// </summary>
