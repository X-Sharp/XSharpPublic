...
#endregion
    private constructor(oType as System.Type, cName as string, oDesc  as ClassDescriptor)
        _type := oType
        _name := cName
        _desc := oDesc
...
#region Class Helper methods
    ...
    internal static method DeleteClass(classObject as ClassObject) as logic
    ...
    internal static method GetClassObject(oObject as object) as ClassObject
