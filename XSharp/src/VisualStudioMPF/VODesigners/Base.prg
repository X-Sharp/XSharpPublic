...
ABSTRACT CLASS WindowDesignerBase INHERIT DesignerBase
	...
	VIRTUAL METHOD GetName() AS STRING
	RETURN NULL
	ABSTRACT METHOD ControlMouseDown(oItem AS DesignWindowItem , eButton AS MouseButtons , oPoint AS Point) AS VOID
	ABSTRACT METHOD ControlMouseUp(oItem AS DesignWindowItem , eButton AS MouseButtons , oPoint AS Point) AS VOID
	ABSTRACT METHOD ControlMouseMove(oItem AS DesignWindowItem , eButton AS MouseButtons , oPoint AS Point) AS VOID
	ABSTRACT METHOD ControlMouseDoubleClick(oItem AS DesignWindowItem , eButton AS MouseButtons , oPoint AS Point) AS VOID
	VIRTUAL METHOD LoadForm(cFileName AS STRING,cFormName AS STRING) AS VOID
	VIRTUAL METHOD SaveContents(oRead AS System.IO.StreamReader , oStream AS System.IO.StreamWriter) AS VOID
	VIRTUAL METHOD PreSaveContents() AS VOID
	VIRTUAL METHOD PostSaveContents() AS VOID
