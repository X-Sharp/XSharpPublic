...
BEGIN NAMESPACE XSharp.VFP.UI
    ...
    /// <summary>
    /// VFP Cursor (DbCursor) - Represents a VFP data cursor/table
    /// Wraps DBF table access via DbUseArea/DbDataSource with BindingSource support
    /// Used by DataEnvironment to supply bound data to Form and Grid controls
    /// </summary>
    PARTIAL CLASS DbCursor
        ...
        /// <summary>
        /// Specifies an ascending or descending order for the controlling index tag
        /// </summary>
        ...
        METHOD Open() AS VOID
            ...
            IF SELF:IsFreeTable
                ...
                // And attach the corresponding DataSource
