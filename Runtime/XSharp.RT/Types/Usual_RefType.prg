    ...
    public structure __Usual implements IConvertible,IComparable
        ...
        #region constructors
            ...
            if value < Int64.MaxValue
                self:_flags:usualType	:= UsualType.INT64
                self:_refData:= (int64) value
            else
                self:_flags:usualType	:= UsualType.FLOAT
                self:_refData := (real8) value
            endif
            return
                ...
                if o:GetType() == typeof(__Usual)
                    ...
                    switch typeCode
                        ...
                        case System.TypeCode.Boolean
                            self:_flags:usualType := UsualType.LOGIC
                            self:_refData := (logic)o 
                        
                        case System.TypeCode.Char
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (char)o 
                        
                        case System.TypeCode.SByte
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (SByte)o 
                        
                        case System.TypeCode.Byte
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (byte)o 
                        
                        case System.TypeCode.Int16 
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (short)o 
                        
                        case System.TypeCode.UInt16
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (word)o 
                        
                        case System.TypeCode.Int32
                            self:_flags:usualType		:= UsualType.Long
                            self:_refData	:= (long)o 
                        
                        case System.TypeCode.UInt32
                            if (dword)o  <= Int32.MaxValue
                                self:_flags:usualType := UsualType.Long
                                self:_refData := (long)(dword)o  
                            else
                                self:_flags:usualType := UsualType.Float
                                self:_refData:= (real8) (UInt32) o 
                                self:_flags:width	:= -1
                                self:_flags:decimals := -1
                            endif
                        case System.TypeCode.Int64 
                            self:_flags:usualType		:= UsualType.Int64
                            self:_refData	:= (int64)o 
                        
                        case System.TypeCode.UInt64 
                            if (uint64) o  <= Int64.MaxValue
                                self:_flags:usualType	:= UsualType.Int64
                                self:_refData		:= (int64)(uint64)o  
                            else
                                self:_flags:usualType := UsualType.FLOAT
                                self:_refData := (real8)(uint64)o  
                                self:_flags:width	:= -1
                                self:_flags:decimals := -1
                            endif
                        case System.TypeCode.Single  
                            self:_flags:usualType		:= UsualType.Float
                            self:_refData	:= (real8)o 
                            self:_flags:width	:= -1
                            self:_flags:decimals := -1
                        ...
                        case System.TypeCode.DateTime 
                            self:_flags:usualType := UsualType.DateTime
                            self:_refData := (System.DateTime) o 
        ...
        #region properties
            ...
            private property _dateValue		as Date		get (Date) _refData 
            private property _dateTimeValue as DateTime get (DateTime) _refData
            private property _decimalValue	as System.Decimal get (System.Decimal) _refData 
            private property _floatValue    as Float get Float{ (Real8) _refData, _width, _decimals}
            private property _i64Value		as int64	get (int64) _refData
            private property _intValue		as int		get (int) _refData
            private property _logicValue	as logic	get (logic) _refData
            private property _ptrValue		as IntPtr	get (IntPtr) _refData
            private property _r8Value		as real8	get (Real8) _refData
            private property _stringValue   as string	get iif(IsString, (string) _refData , String.Empty)
            private property _symValue		as Symbol	get (Symbol) _refData 
            ...
            try
                switch u:_usualType
                    ...
                    case UsualType.Float	
						...
						ELSE
							var r8 := u:_r8Value
							return  checked((int64) r8)
						endif
                    case UsualType.Decimal
						if RuntimeState.CompilerOptionVO11
							return Convert.ToInt64(u:_decimalValue )
						ELSE
							var dec := u:_decimalValue 
							return checked((int64) dec)
						endif
