...
namespace XSharp.MacroCompiler
{
    ...
    {
        internal string Name;
        internal override TypeSymbol Type { get { return (Binder.Lookup(XSharpQualifiedFunctionNames.IVarGet) as MethodSymbol)?.Type ?? Compilation.Get(NativeType.Object); } }
