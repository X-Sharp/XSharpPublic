...
BEGIN NAMESPACE XSharp.VFP.UI
	...
	CLASS Header INHERIT System.Windows.Forms.DataGridViewColumnHeaderCell
		...
		// ── Caption ───────────────────────────────────────────────────────────
		/// <summary>
		/// VFP Caption — the header label text. Alias for <see cref="Text"/>; both properties read and write the same underlying value.
		/// </summary>
		...
		/// <summary>
		/// Programmatic name of the Header object — used by VFP code to reference the header.
		/// </summary>
		...
		// ── ForeColor / BackColor ─────────────────────────────────────────────
		/// <summary>
		/// Foreground (text) colour of the column header, written to <c>Style.ForeColor</c>.
		/// </summary>
		...
		/// <summary>
		/// Background colour of the column header cell, written to <c>Style.BackColor</c>.
		/// </summary>
		...
		/// <summary>
		/// Font family name of the column header text, written to <c>Style.Font</c>. Falls back to the system default font when no style font has been set.
		/// </summary>
		...
		/// <summary>
		/// When <c>.T.</c>, renders the header text in italic. Modifies <c>Style.Font</c> while preserving the existing family, size, and other style bits.
		/// </summary>
		...
		/// <summary>
		/// When <c>.T.</c>, underlines the header text. Modifies <c>Style.Font</c> while preserving the existing family, size, and other style bits.
		/// </summary>
		...
		// ── FontBold ──────────────────────────────────────────────────────────
		/// <summary>
		/// When <c>.T.</c>, renders the header text bold. Modifies <c>Style.Font</c> while preserving the existing family, size, and other style bits.
		/// </summary>
		...
		// ── FontStrikeThru ───────────────────────────────────────────────────
		/// <summary>
		/// When <c>.T.</c>, draws a strikethrough line through the header text. Modifies <c>Style.Font</c> while preserving the existing family, size, and other style bits.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the user clicks the column header. Wired via <see cref="Column"/>'s <c>OnDataGridViewChanged</c> to <c>DataGridView.ColumnHeaderMouseClick</c>.
		/// </summary>
		...
		/// <summary>
		/// Invokes the <see cref="vfpClick"/> handler. Called by the owning <see cref="Column"/> when a left-button header click is detected.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the user right-clicks the column header.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpRightClick"/> handler. Called by the owning <see cref="Column"/> on a right-button header click.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the user double-clicks the column header.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpDblClick"/> handler. Called by the owning <see cref="Column"/> on a header double-click.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when a mouse button is pressed over the column header.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpMouseDown"/> handler.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when a mouse button is released over the column header.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpMouseUp"/> handler.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the mouse pointer moves over the column header.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpMouseMove"/> handler.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the mouse pointer enters the column header area.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpMouseEnter"/> handler.
		/// </summary>
		...
		/// <summary>
		/// Name of the VFP method to call when the mouse pointer leaves the column header area.
		/// </summary>
		[System.ComponentModel.Category("VFP Events"), System.ComponentModel.DefaultValue("")];
		...
		/// <summary>
		/// Invokes the <see cref="vfpMouseLeave"/> handler.
		/// </summary>
