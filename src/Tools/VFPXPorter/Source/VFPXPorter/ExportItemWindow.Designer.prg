...
BEGIN NAMESPACE VFPXPorter
    PUBLIC PARTIAL CLASS ExportItemWindow
        ...
        /// </summary>
            ...
            SELF:label2:Size := System.Drawing.Size{63, 16}
            ...
            SELF:analysisButton:TabIndex := 7
