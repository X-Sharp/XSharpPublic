...
namespace XSharp.Project
{
    ...
    public class XFileNode : FileNode, IProjectSourceNode
    {
        ...
        protected override int QueryStatusOnNode(Guid guidCmdGroup, uint cmd, IntPtr pCmdText, ref QueryStatusResult result)
        {
            ...
            int returnCode;
            if (XSharpHelperMethods.QueryStatusOnProjectSourceNode(this, guidCmdGroup, cmd, ref result, out returnCode))
            {
                return returnCode;
            }
        ...
        protected void ResetProperties()
        {
            ...
            if (this.IsNonMemberItem)
            {
                if (!(this.NodeProperties is XSharpFileNodeNonMemberProperties))
                {
                    change = true;
                }
            }
