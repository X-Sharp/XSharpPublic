...
/// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo/*" />
CLASS RddFieldInfo
#region static
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Name/*" />
    PUBLIC Name 		AS STRING
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.FieldType/*" />
    PUBLIC FieldType 	AS DbFieldType
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Length/*" />
    PUBLIC Length 		AS LONG
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Decimals/*" />
    PUBLIC Decimals 	AS LONG
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Alias/*" />
    PUBLIC Alias 		AS STRING
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Flags/*" />
    PUBLIC Flags        AS DBFFieldFlags
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Offset/*" />
    PUBLIC Offset       AS LONG
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Ordinal/*" />
    PUBLIC Ordinal      AS LONG
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.NextValue/*" />
    PUBLIC NextValue    AS LONG
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.StepValue/*" />
    PUBLIC StepValue    AS LONG

    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Properties/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.HasProperties/*" />
    property HasProperties as logic get _lazyProperties != null
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.FieldTypeFlags/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.ctor/*" />
    CONSTRUCTOR(sName AS STRING, sType AS STRING, nLength AS LONG, nDecimals AS LONG, nOffSet := -1 AS LONG)
        ...
        SELF:Validate()
        RETURN
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.ctor_2/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.ctor_3/*" />
    CONSTRUCTOR(oInfo AS RddFieldInfo)
        SUPER()
        SELF:CopyValues(oInfo)
        SELF:Validate()

    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.CopyValues/*" />
    METHOD CopyValues(oInfo AS RddFieldInfo) AS VOID
        ...
        return
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.BlankValue/*" />
    METHOD BlankValue() AS OBJECT
        ...
        END SWITCH
        RETURN NULL
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Clone/*" />
    METHOD Clone() AS RddFieldInfo
        VAR info := (RddFieldInfo) SELF:MemberwiseClone()
        RETURN info

    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.SameType/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Validate/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.FieldTypeStr/*" />
    PROPERTY FieldTypeStr       AS STRING GET ((CHAR) SELF:FieldType):ToString()
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsMemo/*" />
    PROPERTY IsMemo             AS LOGIC GET SELF:FieldType:IsMemo()
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsBinary/*" />
    PROPERTY IsBinary           AS LOGIC GET SELF:FieldType:IsBinary() .OR. SELF:Flags:HasFlag(DBFFieldFlags.Binary)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsNullable/*" />
    PROPERTY IsNullable         AS LOGIC GET SELF:Flags:HasFlag(DBFFieldFlags.Nullable)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsAutoIncrement/*" />
    PROPERTY IsAutoIncrement    AS LOGIC GET SELF:Flags:HasFlag(DBFFieldFlags.AutoIncrement)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsStandard/*" />
    PROPERTY IsStandard         AS LOGIC GET SELF:FieldType:IsStandard()
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsVfp/*" />
    PROPERTY IsVfp              AS LOGIC GET SELF:FieldType:IsVfp()
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsVarLength/*" />
    PROPERTY IsVarLength        AS LOGIC GET SELF:FieldType:IsVarLength()
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsUnicode/*" />
    PROPERTY IsUnicode          AS LOGIC GET SELF:Flags:HasFlag(DBFFieldFlags.Unicode)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsEncrypted/*" />
    PROPERTY IsEncrypted        AS LOGIC GET SELF:Flags:HasFlag(DBFFieldFlags.Encrypted)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsCompressed/*" />
    PROPERTY IsCompressed       AS LOGIC GET SELF:Flags:HasFlag(DBFFieldFlags.Compressed)
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.CanSort/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Caption/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Description/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.InputMask/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.Format/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.ColumnName/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.PrimaryKey/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.DefaultValue/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.IsUnique/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.RuleExpression/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/RddFieldInfo.RuleText/*" />
