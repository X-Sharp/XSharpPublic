...
namespace XSharp.Project
{
    ...
    /// </remarks>
    ///
    [Description(XSharpConstants.UIToolsName)]
    ...
    [Guid(XSharpConstants.guidUIpPkgString)]
#if REPOWINDOW
    ...
    public sealed class XSharpUIToolsPackage : ToolkitPackage, IVsShellPropertyEvents, IDisposable
    {
        private static XSharpUIToolsPackage instance = null;
        //private XSharpProjectSelector _projectSelector = null;
        private uint shellCookie;
        IVsShell shell = null;

        public static XSharpUIToolsPackage XInstance => instance;

        // =========================================================================================
        // Properties
        // =========================================================================================

        public XSharpUIToolsPackage() : base()
        {
            instance = this;
        }
