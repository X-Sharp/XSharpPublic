            ...
            if (codeStream is DocDataTextReader)
            {
                ...
                if (XSharpCodeDomHelper.HasPartialClass(compileUnit, out nameSpace, out className))
                {
                    ...
                    if (File.Exists(designerPrgFile))
                    {
                        ...
                        compileUnit.UserData[XSharpCodeConstants.USERDATA_HASDESIGNER] = true;
                        compileUnit.UserData[XSharpCodeConstants.USERDATA_FILENAME] = prgFileName;
                        // Save CCU for GenerateCode operation, it will be faster and easier than to recreate it
                        compileUnit.UserData[XSharpCodeConstants.USERDATA_CCU_FORM] = compileUnit;
                        compileUnit.UserData[XSharpCodeConstants.USERDATA_CCU_DESIGNER] = designerCompileUnit;
                    }
                }
            }
            else
