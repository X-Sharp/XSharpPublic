...
/// <include file="Report.xml" path="doc/HiddenWndClass.ParentWnd/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.OpenNames/*" />
ACCESS OpenNames AS ARRAY
RETURN aOpenNames


/// <include file="Report.xml" path="doc/ReportQueue.OpenIndex/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.ActiveFile/*" />
ACCESS ActiveFile()
	IF nOpenIndex > 0
...
/// <include file="Report.xml" path="doc/ReportQueue.Close/*" />
METHOD Close()
	SELF :__QorExecute(DDEMC{TRUE,"FILE.CLOSE()"})
	RETURN SELF


/// <include file="Report.xml" path="doc/ReportQueue.CloseAll/*" />
METHOD CloseAll()
	SELF :__QorExecute(DDEMC{FALSE,"WINDOW.CLOSE.ALL()"})
	RETURN SELF


/// <include file="Report.xml" path="doc/ReportQueue.ConnectToDB/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.DataUpdate/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Edit/*" />
METHOD Edit()
...
/// <include file="Report.xml" path="doc/ReportQueue.EventType/*" />
ACCESS EventType()
	RETURN _event
...
/// <include file="Report.xml" path="doc/ReportQueue.Filename/*" />
ACCESS Filename()
	RETURN RETname
...
/// <include file="Report.xml" path="doc/ReportQueue.Hide/*" />
METHOD Hide()
	SELF :__QorExecute(DDEMC{FALSE,"APP.HIDE"})
	RETURN SELF


/// <include file="Report.xml" path="doc/ReportQueue.ctor/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.NEW/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Open/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Origin/*" />
...
ACCESS __Owner as Window
    return oOwner
/// <include file="Report.xml" path="doc/ReportQueue.owner/*" />
ACCESS owner()
	RETURN oOwner


/// <include file="Report.xml" path="doc/ReportQueue.Preview/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Print/*" />
...
ENDTEXT
*/
/// <include file="Report.xml" path="doc/ReportQueue.ReportExit/*" />
METHOD ReportExit()                            //451@AJP001
	SELF :__QorExecute(DDEMC{TRUE,"FILE.EXIT()"})
	RETURN SELF


/// <include file="Report.xml" path="doc/ReportQueue.ReportServer/*" />
ACCESS ReportServer()
	RETURN servername


/// <include file="Report.xml" path="doc/ReportQueue.SaveToFile/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.SetPapersize/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.SetPrinterOrientation/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.SetReportQuery/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.SetSQLFile/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.SetSQLText/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Show/*" />
...
/// <include file="Report.xml" path="doc/ReportQueue.Size/*" />
