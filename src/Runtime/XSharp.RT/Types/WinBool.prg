...
/// <include file="XSharp.RT.Docs.xml" path="doc/__WinBool/*" />
...
PUBLIC STRUCT __WinBool IMPLEMENTS ISerializable
    ...
    /// <include file="XSharp.RT.Docs.xml" path="doc/__WinBool.Value/*" />
    ...
    /// <include file="XSharp.RT.Docs.xml" path="doc/__WinBool.ctor/*" />
    [NODEBUG]  [INLINE];
