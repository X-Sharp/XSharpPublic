    ...
    BEGIN SEQUENCE
        ...
        IF lSelectionActive
            ...
            IF ! VODBSeek( uValue, FALSE )
                SELF:__SetStatusHL( __FUNCTION__, EG_ARG, __CavoStr( __CAVOSTR_DBFCLASS_NOSEEK ) )
                oHLTemp := oHLStatus
                aResult := NULL_ARRAY
            ELSE
            ...
            IF lSelectionActive
                ...
                ELSE
                    ...
                    ELSE
                        ...
                        SELF:__SetStatusHL( __FUNCTION__, EG_BOUND, __CavoStr( __CAVOSTR_DBFCLASS_SELECTIVEVALUE ) )
                        oHLTemp := oHLStatus
                        lRetCode := FALSE
                    ENDIF
                ENDIF
...
#ENDIF
    ...
    BEGIN SEQUENCE
        ...
        //BREAK DbError{SELF, __FUNCTION__, EG_ARG, "", kOrderInfoType, "kOrderInfoType" }
        BREAK ErrorBuild(_VODBErrInfoPtr())
        ENDIF
        */
