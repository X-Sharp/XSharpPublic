...
public interface Vulcan.IDate
    property IsEmpty as Logic get
    property Value as System.DateTime get set
end interface

structure Vulcan.__VODate implements System.IComparable, System.IFormattable, System.IConvertible, IDate
    ...
    method Add(days as real8) as __VODate
		return __VODate{(self:value:AddDays(days))}
    ...
    method Add(span as System.TimeSpan) as __VODate
		return __VODate{(self:value:Add(span))}
