...
namespace XSharp.Project.FileCodeModel
{
    ...
    /// 
    /// </summary>
    public abstract class FileCodeModelBase : SimpleCodeElement, EnvDTE.FileCodeModel
    {
        ...
        // TODO : Move to XSharp.Constants
        public static string USERDATA_FILECODEMODEL = "XSharp:FileCodeModel"; // Logical value
        ...
        private void EnsureNamespaceLinked(CDCodeNamespace member)
        {
            if (member.UserData[CodeKey] == null)
            {
                ...
                //member.UserData[USERDATA_FILECODEMODEL] = this;
            }
        }
