...
METHOD OKButtonClick(sender AS OBJECT , e AS System.EventArgs) AS VOID
	...
	IF SELF:orbSolution:Checked
		SolutionConverter.Convert(SELF:otbFileName:Text, oDlg)
	ELSE
...
METHOD rbSolutionClick(sender AS System.Object , e AS System.EventArgs) AS VOID
	SELF:SetDescription()
RETURN                             
METHOD EnableButtons() AS VOID    
...
METHOD rbProjectClick(sender AS System.Object , e AS System.EventArgs) AS VOID
	SELF:SetDescription()	
RETURN


METHOD FileButtonClick(sender AS System.Object , e AS System.EventArgs) AS VOID
...
METHOD BasicFormShown(sender AS System.Object , e AS System.EventArgs) AS VOID
	SELF:SetDescription()
	SELF:EnableButtons()
RETURN

METHOD CancelButtonClick(sender AS System.Object , e AS System.EventArgs) AS VOID
	SELF:Close()
RETURN

METHOD tbFileNameTextChanged(sender AS System.Object , e AS System.EventArgs) AS VOID
	SELF:EnableButtons()
RETURN
