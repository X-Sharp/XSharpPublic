...
namespace LanguageService.CodeAnalysis {
    ...
    internal class XSharpResources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to Feature &apos;{0}&apos; is not available in X# 7.  Please use language version {1} or greater..
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Fixed size buffer type must be one of the following: bool, byte, short, int, long, char, sbyte, ushort, uint, ulong, float or double (also ptr or vostruct in vo/vulcan dialect).
        /// </summary>
        ...
        /// <summary>
        ///   Looks up a localized string similar to Cannot convert method group &apos;{0}&apos; to non-delegate type &apos;{1}&apos;. Did you forget the parenthesis?.
        /// </summary>
