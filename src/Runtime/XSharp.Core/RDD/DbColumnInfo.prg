...
CLASS XSharp.RDD.DbColumnInfo INHERIT RddFieldInfo
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.DotNetType/*" />
    PROPERTY DotNetType     AS System.Type AUTO
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.NumericScale/*" />
    PROPERTY NumericScale   AS LONG AUTO
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.NumericPrecision/*" />
    PROPERTY NumericPrecision AS LONG AUTO
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.ReadOnly/*" />
    PROPERTY ReadOnly AS LOGIC AUTO
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.ctor/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.ctor_2/*" />
    CONSTRUCTOR(oInfo AS RddFieldInfo)
        SUPER(oInfo)
        SELF:CalculateColumnType()
        RETURN

    /// <include file="XSharp.CoreDocs.xml" path="doc/DbColumnInfo.CalculateColumnType/*" />
