...
namespace XSharp.MacroCompiler.Syntax
{
    ...
    {
        internal Expr Var;
        internal MemvarExpr(Expr var, Token o) : base(o) { Var = var; }
        public override string ToString() { return "(M->" + Var.ToString() + ")"; }
    }
    ...
    {
        internal Expr Expr;
        internal RuntimeIdExpr(Token o, Expr e) : base(o) { Expr = e; }
        public override string ToString() { return "(&" + Expr.ToString() + ")"; }
    }
    ...
    internal partial class CodeblockExpr : Expr
    {
        ...
        internal CodeblockExpr(Token o, Codeblock cb) : base(o) { Codeblock = cb; }
        public override string ToString() { return Codeblock.ToString(); }
    }
}
