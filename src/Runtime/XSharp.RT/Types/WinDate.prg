...
/// <include file="XSharp.RT.Docs.xml" path="doc/__WinDate/*" />
...
PUBLIC STRUCT __WinDate IMPLEMENTS ISerializable
    ...
    /// <include file="XSharp.RT.Docs.xml" path="doc/__WinDate.Value/*" />
    PUBLIC PROPERTY @@Value AS DATE => (DATE) _value
    /// <include file="XSharp.RT.Docs.xml" path="doc/__WinDate.JulianValue/*" />
    PUBLIC PROPERTY @@JulianValue AS INT => (INT) _value

    PRIVATE CONSTRUCTOR(@@value AS DWORD)
        _value := @@value

    /// <include file="XSharp.RT.Docs.xml" path="doc/__WinDate.ctor/*" />
