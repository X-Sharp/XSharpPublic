...
{
    [Microsoft.VisualStudioTools.Project.PropertyPageTypeConverter(typeof(RunPostBuildEventConverter))]
    ...
    [Microsoft.VisualStudioTools.Project.PropertyPageTypeConverter(typeof(DialectConverter))]
    ...
    public class DialectConverter : EnumConverter
    {
        ...
        public override System.ComponentModel.TypeConverter.StandardValuesCollection GetStandardValues(System.ComponentModel.ITypeDescriptorContext context)
        {
            return new StandardValuesCollection(new Dialect[] { Dialect.Core, Dialect.VO, Dialect.Vulcan, Dialect.Harbour, Dialect.FoxPro, Dialect.dBase, Dialect.Xbasepp });
        }
    }

    [Microsoft.VisualStudioTools.Project.PropertyPageTypeConverter(typeof(PlatformConverter))]
    ...
    [Microsoft.VisualStudioTools.Project.PropertyPageTypeConverter(typeof(DebugTypeConverter))]
