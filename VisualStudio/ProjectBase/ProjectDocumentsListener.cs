...
namespace Microsoft.VisualStudio.Project
{
    ...
    public abstract class ProjectDocumentsListener : IVsTrackProjectDocumentsEvents2, IDisposable
    {
		...
		private IVsTrackProjectDocuments2 _projectDocTracker = null;
        ...
        protected ProjectDocumentsListener(ServiceProvider serviceProviderParameter)
        {
            ...
            Debug.Assert(this._projectDocTracker != null, "Could not get the IVsTrackProjectDocuments2 object from the services exposed by this project");
