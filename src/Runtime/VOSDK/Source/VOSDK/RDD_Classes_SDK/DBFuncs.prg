...
/// <exclude/>
FUNCTION __DBSGoTo( n AS USUAL, nTries := 1 AS DWORD) AS LOGIC STRICT
   LOCAL lOk := FALSE AS LOGIC
   //SE-060527
   DO WHILE nTries > 0
		NetErr( FALSE )
...
/// <include file="Rdd.xml" path="doc/DbSetDefaultLockMode/*" />
...
/// <include file="Rdd.xml" path="doc/DbGetDefaultLockMode/*" />
