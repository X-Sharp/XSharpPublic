...
namespace Microsoft.CodeAnalysis.CSharp
{
    ...
    */
    ...
    internal enum ErrorCode
    {
        ...
        WRN_UnsafeImplied = 19001,
        ERR_ParserError = 19002,
        ERR_PreProcessorError = 19003,
        WRN_PreProcessorWarning = 19004,
        ERR_PreProcessorRecursiveRule = 19005,
        ERR_IllegalCombinationOfCommandLineOptions = 19006,
        ERR_FeatureNotAvailableInDialect = 19007,
        ERR_UntypedArrayNotAvailableInDialect = 19008,
        ERR_TypedParametersWithClipperCallingConvention = 19009,
        ERR_OnlySupportedForClipperCallingConvention = 19010,
        ERR_AmbiguousCase = 19011,
        WRN_DuplicateDefineDiff = 19012,
        WRN_DuplicateDefineSame = 19013,
        ERR_DialectRequiresReferenceToRuntime = 19014,
        WRN_ImplicitParentConstructorInitializer = 19015,
        ERR_NestedMethodMustHaveSameNameAsParentClass = 19016,
        ERR_InvalidDialect = 19017,
        ERR_InvalidDLLEntryPoint = 19018,
        ERR_CompilerOptionNotSupportedForDialect = 19019,
        WRN_ConversionMayLeadToLossOfData = 19020,
        WRN_Conversion = 19021,
        ERR_ConflictingCommandLineOptions = 19022,
        WRN_AddrOfMovable = 19023,
        ERR_ExitInsideSwitchStatementNotAllowed = 19024,
        WRN_MissingReturnStatement = 19025,
        WRN_MissingReturnValue = 19026,
        ERR_IllegalVoStructMemberType = 19027,
        ERR_UnknownLiteralTypeName = 19028,
        WRN_CompilerOptionNotImplementedYet = 19029,
        ERR_KeywordExpected = 19030,
        ERR_VulcanArrayDimAndInit = 19031,
        WRN_NoReturnValueAllowed = 19032,
        ERR_InitProceduresCannotDefineParameters = 19033,
        WRN_SuppressAxitMethodCall = 19034,
        ERR_PCallFirstArgument = 19035,
        ERR_PCallNativeGenericType = 19036,
        ERR_PCallTypedPointerName = 19037,
        ERR_PCallResolveGeneratedDelegate = 19038,
        ERR_AccessAssignParametersMutchMatch = 19039,
        ERR_AccessAssignTypesMutchMatch = 19040,
        ERR_ClipperInParentClass = 19041,
        ERR_ClipperInSubClass = 19042,
        WRN_XSharpAmbiguous = 19043,
        ERR_ImplicitlyTypedVariableCannotBeStatic = 19044,
        ERR_StaticLocalInCodeBlock = 19045,
        ERR_CannotAssignToMethod = 19046,
        WRN_GetSetMustHaveBody = 19047,
        ERR_AssignMethodsMustHaveAParameter = 19048,
        ERR_NoClipperCallingConventionForAccessAssign = 19049,
        ERR_ExpectedEndOfStatement = 19050,
        WRN_GeneratingGetAccessor = 19051,
        ERR_CannotTakeAddressOfFunctionOrMethod = 19052,
        ERR_NoOverloadFoundThatAllowsMissingArguments = 19053,
        WRN_ArgumentNameLocalNamePossibleConflict = 19054,
        ERR_CodeblockWithLambdaSyntax = 19055,
        ERR_LamdaWithCodeblockSyntax = 19056,
        ERR_CodeBlockWithTypeParameters = 19057,
        WRN_LamdaExpressionWithPipes = 19058,
        ERR_CannotConvertArrayIndexAccess = 19059,
        ERR_NoExplicitCast = 19060,
        ERR_PtrCastNotAllowed = 19061,
        ERR_TypeNameMatchesGlobalNamespace = 19062,
        WRN_NullPointerForRefParameter = 19063,
        WRN_AssgReadonlyLocalCause = 19064,
        ERR_AssignmentOperatorExpected = 19065,
        WRN_FunctionsTakePrecedenceOverMethods = 19066,
        ERR_InterfaceImplementationDifferentCallingConvention = 19067,
        WRN_CompilerGeneratedPSZConversionGeneratesMemoryleak = 19068,
        WRN_ArgumentRefParameterOut = 19069,
        WRN_ImplicitCast = 19070,
        WRN_AutomaticRefGeneration = 19071,
        ERR_DefaultParameterValueWithClipperCallingConvention = 19072,
        WRN_UndeclaredVariable = 19073,
        ERR_ParametersWithDeclaredParameters = 19074,
        ERR_MemvarFieldWithSameName = 19075,
        WRN_EmptyStatement = 19076,
        Err_TypeParametersAccessAssign = 19077,
        Err_StringConcat = 19078,
        ERR_CannotTakeAddressOfAliasedExpression = 19079,
        ERR_InvalidLiteral = 19080,
        WRN_ObsoleteInclude = 19081,
        ERR_MissingWithStatement = 19082,
        ERR_CantCastPtrInAnyCpu = 19083,
        ERR_CantCastPtrInPlatform = 19084,
        WRN_UnbalancedTextMergeOperators = 19085,
        ERR_MissingEndText = 19086,
        WRN_ASend = 19087,
        ERR_UnexpectedCommand = 19088,
        ERR_FunctionsCannotHaveInitExit = 19089,
        ERR_DLLMethodNotSupported = 19090,
        ERR_DynamicVariablesNotAllowed = 19091,
        WRN_UndeclaredVariableOrCursor = 19092,
        WRN_UndeclaredCursor = 19093,
        WRN_UndeclaredVariableLatebound = 19094,
        ERR_CurrencyTypeNotSupported = 19095,
        WRN_IllegalPPOption = 19096,
        ERR_CaseDifference = 19097,
        WRN_UndeclaredMember = 19098,
        ERR_MemvarInit = 19099,
        WRN_ChrInDefine = 19100,
        WRN_TryWithoutCatch = 19101,
        WRN_Unsupported = 19102,
        ERR_UnExpectedExpected = 19103,
        ERR_ExpressionBodyClipperCallingConvention = 19104,
        WRN_PropertyTypeChangedInParentType = 19105,
        ERR_MethodSignatureChanged = 19106,
        ERR_NILByRefOrOut = 19107,
        WRN_MissingWithStatement = 19108,
        ERR_BadAddressOfArg = 19109,
        WRN_String2PszMustBeAssignedToLocal = 19110,
        ERR_DefineIncorrectValue = 19111,
        ERR_DotForInstanceMember = 19112,
        ERR_InvalidStackAlloc = 19113,
        ERR_ColonForStaticMember = 19114,
        ERR_ColonForTypeOrNs = 19115,
        WRN_NullPszForStringArgument = 19116,
        WRN_ConversionFromNilNotSupported = 19117,
        WRN_ParameterMustBeTyped = 19118,
        WRN_PropertyParametersBrackets = 19119,
        ERR_ParameterInit = 19120,
        ERR_LambdaConversionNotPossible = 19121,
        WRN_FileWideMemVarName = 19122,
        ERR_UnexpectedNamedArgument = 19123,
        ERR_ParenthesizedExpressionList = 19224,
        WRN_FileWideMemVarDuplicate = 19125,
        ERR_ClipperOverloaded = 19126,
        ERR_AutoPropertyParameters = 19127,
        ERR_IndexPropertyLineAccessors = 19128,
