    ...
    internal sealed class NativeViewExpansion : Expansion
    {
            ...
            EvalResultDataItem parent)
        {
            ...
            catch (DkmException)
            {
                ...
                return new EvalResult(LanguageService.CodeAnalysis.ExpressionEvaluator.Resources.NativeView, LanguageService.CodeAnalysis.ExpressionEvaluator.Resources.NativeViewNotNativeDebugging, inspectionContext);
            }
