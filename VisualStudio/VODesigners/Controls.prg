...
INTERNAL CLASS DesignPushButton INHERIT Button IMPLEMENTS ITestableControl
	...
	PROPERTY lTestMode AS LOGIC AUTO
...
INTERNAL CLASS DesignFixedText INHERIT Label IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignCheckBox INHERIT CheckBox  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignRadioButton INHERIT RadioButton  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignEdit INHERIT TextBox  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignComboBox INHERIT ComboBox  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignListBox INHERIT ListBox  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignListView INHERIT ListView  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignTreeView INHERIT TreeView  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignProgressBar INHERIT ProgressBar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignGroupBox INHERIT GroupBox  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignMonthCalendar INHERIT MonthCalendar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignHorizontalScrollBar INHERIT HScrollBar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
	...
	RETURN oParams
END CLASS
INTERNAL CLASS DesignVerticalScrollBar INHERIT VScrollBar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignHorizontalSlider INHERIT TrackBar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
	...
	RETURN oParams
END CLASS
INTERNAL CLASS DesignVerticalSlider INHERIT TrackBar  IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignHorizontalSpinner INHERIT HScrollBar IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
	...
	RETURN oParams
END CLASS
INTERNAL CLASS DesignVerticalSpinner INHERIT VScrollBar IMPLEMENTS ITestableControl
	PROPERTY oItem AS DesignWindowItem AUTO
	PROPERTY lTestMode AS LOGIC AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL CLASS DesignTabControl INHERIT TabControl IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
	...
	RETURN oParams
END CLASS
INTERNAL CLASS DesignTabPage INHERIT TabPage IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
...
INTERNAL CLASS DesignbBrowser INHERIT Panel IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
...
INTERNAL CLASS DesignDataColumn INHERIT PictureBox IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
...
INTERNAL CLASS DesignEmpty INHERIT Panel IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
	PROTECT oBrush AS SolidBrush
	PROTECT oSF AS StringFormat
...
INTERNAL CLASS DesignNativeWindow INHERIT NativeWindow IMPLEMENTS ITestableControl
	PROPERTY lTestMode AS LOGIC AUTO
	PROPERTY oItem AS DesignWindowItem AUTO
	CONSTRUCTOR(_oItem AS DesignWindowItem)
		SUPER()
...
INTERNAL FUNCTION GetButtonAlignment(oItem AS DesignWindowItem , lText AS LOGIC) AS ContentAlignment
	...
	LOCAL cValue AS STRING
	LOCAL lExLeft := FALSE AS LOGIC
	LOCAL lTextLeft := FALSE AS LOGIC
	LOCAL x,y AS INT
