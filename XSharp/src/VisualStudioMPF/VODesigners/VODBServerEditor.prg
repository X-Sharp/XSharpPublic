...
PARTIAL CLASS VODBServerEditor INHERIT DesignerBase
	...
	EXPORT oIndexList AS DBEListView
	EXPORT oOrderList AS DBEListView
	EXPORT oFieldList AS DBEListView
...
//					oProject:RemoveVOBinary(cFileName)
	...
	METHOD ReadAllAvailableFieldspecs(cModule AS STRING) AS VOID
		...
		LOCAL oBinary AS Vulcan.CodeModel.VOBinary
		...
		aVnfs := SELF:oProject:GetBinaries(Vulcan.CodeModel.VOBinaryType.FieldSpec , TRUE)
