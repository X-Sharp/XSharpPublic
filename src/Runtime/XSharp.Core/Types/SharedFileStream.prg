...
BEGIN NAMESPACE XSharp.IO
    /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream/*" />
    CLASS XsWin32FileStream INHERIT XsFileStream
        ...
        INTERNAL CONSTRUCTOR(path AS STRING, mode AS FileMode, faccess AS FileAccess, share AS FileShare, bufferSize AS LONG, options AS FileOptions) 
            ...
            smallBuff := BYTE[]{1}
        RETURN
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Seek/*" />
        ...
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.SetLength/*" />
        PUBLIC OVERRIDE METHOD SetLength(length AS INT64 ) AS VOID
            ...
            SetEndOfFile(hFile)
        RETURN
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Length/*" />
        PUBLIC OVERRIDE PROPERTY Length AS INT64
            ...
            END GET
        END PROPERTY
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Read/*" />
        PUBLIC OVERRIDE METHOD Read(bytes AS BYTE[] , offset AS INT, count AS INT) AS INT
            ...
            ENDIF
        RETURN bytesRead
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Write/*" />
        PUBLIC OVERRIDE METHOD Write(bytes AS BYTE[] , offset AS INT , count AS INT) AS VOID
            ...
            ENDIF
        RETURN
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.WriteByte/*" />
        PUBLIC OVERRIDE METHOD WriteByte(b AS BYTE ) AS VOID
            SELF:smallBuff[0] := b
            SELF:Write(SELF:smallBuff , 0 , 1)
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Lock/*" />
        PUBLIC OVERRIDE METHOD Lock(position AS INT64, length AS INT64)  AS VOID
            ...
            ENDIF
        RETURN 
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Unlock/*" />
        PUBLIC OVERRIDE METHOD Unlock( position AS INT64, length AS INT64)  AS VOID
            ...
            ENDIF
        RETURN
        /// <include file="XSharp.CoreDocs.xml" path="doc/XsWin32FileStream.Flush/*" />
