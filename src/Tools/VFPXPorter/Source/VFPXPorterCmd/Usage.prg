...
FUNCTION Usage AS VOID
	...
	Console.WriteLine("  -keepFolderStructure / -no...   Preserve the original VFP project folder tree. [true]")
	Console.WriteLine("  -storeInFolders / -no...        Organize into Forms/Libs/... subfolders (only when -noKeepFolderStructure). [false]")
