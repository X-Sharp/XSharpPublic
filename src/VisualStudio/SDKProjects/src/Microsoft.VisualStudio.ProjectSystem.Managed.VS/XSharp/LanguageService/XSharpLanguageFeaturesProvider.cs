...
{
    /// <summary>
    ///     An implementation of <see cref="ILanguageFeaturesProvider"/> to provider X# language-specific features.
    /// </summary>
    [Export(typeof(ILanguageFeaturesProvider))]
    [AppliesTo(ProjectCapability.XSharp)]
    internal class XSharpLanguageFeaturesProvider : ILanguageFeaturesProvider
    {
        ...
        public XSharpLanguageFeaturesProvider()
        {
        }
        ...
        /// </param>
        /// <returns>
        ///     A proper identifier which meets the X# language specification.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        ///     A proper namespace which meets the X# language specification.
        /// </returns>
        /// <exception cref="ArgumentNullException">
        ///     <paramref name="name"/> is <see langword="null"/>.
        /// </exception>
