    ...
    internal sealed class PointerDereferenceExpansion : Expansion
    {
            ...
            EvalResultDataItem parent)
        {
            ...
            return new EvalResult(
                ...
                value: value,
                displayValue: wasExceptionThrown ? string.Format(LanguageService.CodeAnalysis.ExpressionEvaluator.Resources.InvalidPointerDereference, fullName ?? parent.Name) : null,
                expansion: expansion,
