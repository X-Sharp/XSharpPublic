...
/// <include file="XSharp.CoreDocs.xml" path="doc/Workareas/*" />
ABSTRACT CLASS XSharp.RDD.Workareas
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CloseAll/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CommitAll/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CloseArea/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CloseArea_2/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.FindAlias/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.FindEmptyArea/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.GetAlias/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.GetRDD/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.SetArea/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.UnLockAll/*" />
    ...
    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CurrentWorkareaNO/*" />
    PUBLIC PROPERTY CurrentWorkareaNO AS DWORD GET iCurrentWorkarea SET iCurrentWorkarea := VALUE

    /// <include file="XSharp.CoreDocs.xml" path="doc/Workareas.CurrentWorkarea/*" />
