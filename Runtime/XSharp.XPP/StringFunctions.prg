...
/// If <lNoLetter> is set to TRUE  the function returns the position of the first character which is not a letter. </remarks>
/// <seealso cref="O:XPP.Functions.PosLower">
/// <seealso cref="O:XPP.Functions.PosAlpha">
...
/// <remarks>In X# A letter is defined as a character for which the Char.IsLetter() method returns TRUE. 
/// If <lNoLetter> is set to TRUE  the function returns the position of the first character which is not a letter. </remarks>
/// <seealso cref="O:XPP.Functions.PosUpper">
/// <seealso cref="O:XPP.Functions.PosAlpha">
...
/// <param name="nIgnorCharsFromLeft">Number of characters that must be ignored. Defaults to 0.</param>
/// <remarks>In X# A letter is defined as a character for which the Char.IsLetter() method returns TRUE. 
/// If <lNoLetter> is set to TRUE the function returns the position of the first character which is not a letter. </remarks>
/// <seealso cref="O:XPP.Functions.PosUpper">
/// <seealso cref="O:XPP.Functions.PosLower">
...
/// <remarks>If the parameter <<paramref name="nStartPos"/> is not specified the function replaces Len( <paramref name="cReplace"/> ) characters at the end of <paramref name="cString"/>.</remarks>
