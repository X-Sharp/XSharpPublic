...
// some methods were made virtual so they can be overridden in the XSharpCommandBuilder class
...
namespace XSharp.Build
{
    ...
    public class CommandLineBuilderExtension : CommandLineBuilder
    {
        ...
        /// </summary>
        internal virtual void AppendPlusOrMinusSwitch
            (
            string switchName,
            PropertyDictionary bag,
            string parameterName
        ...
        /// </summary>
        internal virtual void AppendSwitchAliased(string switchName, string alias, string parameter)
        {
        ...
        /// </summary>
        internal virtual void AppendSwitchIfNotNull
        (
            string switchName,
