...
BEGIN NAMESPACE XSharp.RDD
	...
	INTERNAL CLASS NtxOrderList
		...
		PUBLIC PROPERTY Count AS LONG GET _Orders:Count
			PUBLIC PROPERTY Focus AS LONG GET _focusNtx
				PUBLIC PROPERTY CurrentOrder AS NtxOrder GET _currentOrder
					...
					PUBLIC METHOD Delete( orderInfo AS DbOrderInfo) AS LOGIC
						LOCAL ntxIndex AS NtxOrder
