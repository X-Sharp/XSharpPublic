...
STATIC CLASS VOWindowEditorTemplate
	STATIC PROTECT aControls AS ArrayList
	STATIC PROTECT aEnumTypes AS Dictionary<STRING,STRING>
	STATIC PROTECT aAssignMap AS Dictionary<STRING,STRING>
	STATIC PROTECT lLoaded AS LOGIC
