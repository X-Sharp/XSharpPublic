...
/// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices/*" />
STATIC CLASS XSharp.Internal.CompilerServices
 /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.StringSubtract/*" />
 ...
 /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.String2Psz/*" />
 ...
 /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.String2PszRelease/*" />
    ...
    /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.EnterBeginSequence/*" />
    STATIC METHOD EnterBeginSequence AS VOID
		RuntimeState.GetInstance():BreakLevel+= 1

    /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.ExitBeginSequence/*" />
    STATIC METHOD ExitBeginSequence	 AS VOID
		RuntimeState.GetInstance():BreakLevel-= 1

 /// <include file="XSharp.RT.Docs.xml" path="doc/CompilerServices.CanBreak/*" />
