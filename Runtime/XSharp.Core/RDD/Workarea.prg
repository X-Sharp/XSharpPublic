...
//            Bottom := SELF:_Bottom    
        ...
        VIRTUAL METHOD Close( ) AS LOGIC
            ...
            SELF:ClearRel()
            SELF:ClearScope()
            // todo close all parent relations
            RETURN TRUE
