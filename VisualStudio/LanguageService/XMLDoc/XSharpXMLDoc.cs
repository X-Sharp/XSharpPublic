...
namespace XSharp.LanguageService
{
    ...
    static public class XSharpXMLDocTools
    {
        ...
        static XSharpXMLDocTools()
        {
            ...
            _XMLMemberIndexService = (IVsXMLMemberIndexService)XSharpLanguageService.GetGlobalService(typeof(SVsXMLMemberIndexService));
        }
    ...
    static public class XSharpXMLDocMember
    {
        ...
        static public string GetMemberSummary(MemberInfo member, XProject project)
        {
            ...
            //
            if (member is Type t)
                declarationAssembly = t.Assembly;
            ...
            {
                XSharpLanguageService.DisplayOutPutMessage("Exception in XSharpXMLDocMember.GetDocSummary");
