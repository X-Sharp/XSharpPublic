        ...
        VIRTUAL METHOD OpenMemFile( info AS DbOpenInfo) AS LOGIC
            ...
            VIRTUAL METHOD TransRec(info AS DbTransInfo) AS LOGIC
                ...
                ELSE
                    ...
                    nCount := info:ItemCount - 1
                    FOR i := 0 UPTO nCount
                        VAR oItem := info:Items[i]
