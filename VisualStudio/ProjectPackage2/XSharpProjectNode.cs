...
namespace XSharp.Project
{
    ...
    internal class XSharpProjectNode : CommonProjectNode
    {
        ...
        internal override XSharpDependentFileNode CreateDependentFileNode(MsBuildProjectElement item)
        {
        ...
        public override Type GetProjectFactoryType() {
            return typeof(XSharpProjectFactory);
        }

        public override string GetProjectName() {
            return "XSharpProject";
        }
