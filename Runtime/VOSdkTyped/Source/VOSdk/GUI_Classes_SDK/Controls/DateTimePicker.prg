...
CLASS DateTimePicker INHERIT TextControl
	...
	ASSIGN DateRange(oNewRange  AS DateRange)
         local dtMin as DateTime
         local dtMax as DateTime
         dtMin := DateTime{oNewRange:Min:Year, oNewRange:Min:Month, oNewRange:Min:Day}
         dtMax := DateTime{oNewRange:Max:Year, oNewRange:Max:Month, oNewRange:Max:Day,23,59,59}
		__DateTimePicker:MinDate := dtMin
		__DateTimePicker:MaxDate := dtMax
