...
SCAN, ENDSCAN, ENDFOR, ENDFUNC, ENDPROC, ENDTRY, ENDWITH, EACH, THISFORM,
LAST_KEYWORD,
...
// Symbols
LPAREN,RPAREN,LCURLY,RCURLY,LBRKT,RBRKT,COLON,COMMA,PIPE,AMP,ADDROF,ALIAS,DOT,COLONCOLON,BACKSLASH,ELLIPSIS,BACKBACKSLASH,DOTDOT,DOTCOLON,
