...
BEGIN NAMESPACE XSharp.VFP.UI
    ...
    /// <summary>
    /// VFP Column Control - Grid column definition
    /// Inherits from DataGridViewTextBoxColumn; exposes Header as VFP Header object
    ///
    /// Implements: IDynamicProperties, IDynamicProperties2, IVFPOwner
    /// Includes: FontProperties.xh
    ///
    /// Base Class: System.Windows.Forms.DataGridViewTextBoxColumn
    /// </summary>
