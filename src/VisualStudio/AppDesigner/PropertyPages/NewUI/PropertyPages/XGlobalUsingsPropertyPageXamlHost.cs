...
{
    /// <summary>
    /// WinForms/WPF bridge host for the Global Usings property page.
    ...
    /// </para>
    /// <para>
    /// The WPF content is a <see cref="XGlobalUsingsPropertyPageView"/> (<c>UserControl</c>)
    /// whose <c>DataContext</c> is an <see cref="XGlobalUsingsPropertyPageViewModel"/> that
    /// reads from and writes back to the MSBuild project via the owning
    /// <see cref="XSharpGlobalUsingsPropertiesPage"/>.
    /// </para>
    /// </remarks>
    internal sealed class XGlobalUsingsPropertyPageXamlHost : XPropertyPageXamlHost
    {
        // =========================================================================================
        // Member Variables
        // =========================================================================================
        ...
        private readonly XGlobalUsingsPropertyPageViewModel _viewModel;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XGlobalUsingsPropertyPageXamlHost"/> class.
        /// </summary>
        /// <param name="parentPropertyPage">The <see cref="XPropertyPage"/> that owns this panel.</param>
        public XGlobalUsingsPropertyPageXamlHost(XPropertyPage parentPropertyPage)
            : base(parentPropertyPage)
        {
            _viewModel = new XGlobalUsingsPropertyPageViewModel(parentPropertyPage);
        ...
        /// <see cref="XGlobalUsingsPropertyPageView"/> <c>UserControl</c>) that will be
        /// hosted inside the <c>ElementHost</c>.
        /// </summary>
        protected override FrameworkElement CreateXamlContent()
            => new XGlobalUsingsPropertyPageView();
