...
FUNCTION Start() AS VOID                                                                                      
	...
	? "SS",AsHexString( SHORT(0x8000) + SHORT(0x7FFF)      ) ; xAssert( SHORT(0x8000) + SHORT(0x7FFF)      == 0xFFFFFFFF )
	? "SS",AsHexString( SHORT(0xFFFF) + SHORT(0xFFFF)      ) ; xAssert( SHORT(0xFFFF) + SHORT(0xFFFF)      == 0xFFFFFFFE )
